...
const Checkout = () => {
  ...
  if (form.checkValidity()) {
    ...
    const orderData = {
      ...
      orderId: Math.floor(1000 + Math.random() * 9000), // Random order number
    };
              ...
              <div className="checkout-left">
                ...
                >
                  <div className="contact-information">
                    ...
                    <p className="mb-4 mt-2">We'll use this email to send you details and updates about your order.</p>
                  ...
                  <div className="billing-address row">
                    ...
                    <p className="mb-4 mt-2">Enter your billing address information.</p>
                  ...
                  <div className="payment-method">
                    ...
                    <p className="mb-4 mt-2">Choose how you'd like to pay.</p>
                  ...
                  <ul>
                    ...
                    <li>
                      <div className="row">
                        ...
                        <div className="col-6">
                          <h3 style={{ float: 'right' }}>{formatPrice(subtotal)}</h3>
                        </div>
                      </div>
                    </li>
                    {discount > 0 && (
                      <li>
                        <div className="row">
                          ...
                          <div className="col-6">
                            <h3 style={{ float: 'right', color: 'green' }}>- {formatPrice(discount)}</h3>
                          </div>
                        </div>
                      </li>
                    )}
                    <li>
                      <div className="row">
                        ...
                        <div className="col-6">
                          <h3 style={{ float: 'right' }}>{formatPrice(total)}</h3>
                        </div>
                      </div>
                    </li>
                  </ul>
